  ...
  clips: [
    {
      ...
      tag: "敢于突破",
      level: "L2",
      thumbnail: "/videos/jhb1_thumb.jpg",
      videoUrl: "/videos/jhb1.mp4",
    ...
    },
    {
      ...
      tag: "快速回防",
      level: "L2",
      thumbnail: "/videos/jhb2_thumb.jpg",
      videoUrl: "/videos/jhb2.mp4",
    ...
    },
    {
      ...
      tag: "主动传球",
      level: "L1",
      thumbnail: "/videos/jhb3_thumb.jpg",
      videoUrl: "/videos/jhb3.mp4",
  ...
  clips: [
    {
      ...
      tag: "快速回防",
      level: "L2",
      thumbnail: "/videos/jhb4_thumb.jpg",
      videoUrl: "/videos/jhb4.mp4",
    ...
    },
    {
      ...
      tag: "主动传球",
      level: "L2",
      thumbnail: "/videos/jhb5_thumb.jpg",
      videoUrl: "/videos/jhb5.mp4",
  ...
  clips: [
    {
      ...
      tag: "主动传球",
      level: "L2",
      thumbnail: "/videos/jhb6_thumb.jpg",
      videoUrl: "/videos/jhb6.mp4",
    ...
    },
    {
      ...
      tag: "敢于突破",
      level: "L1",
      thumbnail: "/videos/jhb7_thumb.jpg",
      videoUrl: "/videos/jhb7.mp4",
  ...
  clips: [
    {
      ...
      tag: "敢于突破",
      level: "L2",
      thumbnail: "/videos/jhb8_thumb.jpg",
      videoUrl: "/videos/jhb8.mp4",
...
export const mockReportRpt005 = {
  id: "rpt-005",
  studentId: "stu-001",
  sessionId: "sess-005",
  title: "蒋皓博 3月28日比赛成长报告",
  date: "2026-03-28",
  type: "match",
  status: "published",
  heroSummary: "这是蒋皓博本赛季第一次在比赛中主动尝试突破，虽然还不够熟练，但那个迈出去的步子，是他迈向自信的起点。每一段成长旅程，都需要这样的第一次。",
  badge: null,
  clips: [
    {
      id: "clip-005-a",
      ...
      tag: "敢于突破",
      level: "L1",
      thumbnail: "/videos/jhb9_thumb.jpg",
      videoUrl: "/videos/jhb9.mp4",
      parentExplanation: "这是蒋皓博本赛季第一次在比赛中主动选择突破，虽然被防住了，但他有了这个念头并且付诸行动，这一步非常重要。",
      coachComment: "第一次主动突破意图出现，这是很好的信号。动作还需要打磨，但勇气已经有了。下个阶段会专门练习突破的起步时机。",
      timestamp: "09:18",
    },
    {
      id: "clip-005-b",
      ...
      thumbnail: "/videos/jhb1_thumb.jpg",
      videoUrl: "/videos/jhb1.mp4",
      parentExplanation: "蒋皓博开始主动参与进攻，不再只是站在外线等待，说明他对自己在比赛中的角色有了新的认识。",
      coachComment: "比赛参与感提升，主动要球的意识开始出现。这是建立比赛自信的第一步，继续鼓励他主动参与。",
      timestamp: "22:05",
    },
  ],
  progressPoints: [
    "本赛季首次在比赛中主动尝试突破，进攻意识萌芽",
    "比赛参与感提升，不再被动等待",
  ],
  improvementPoints: [
    "突破动作还需要更多训练，起步时机和路线选择都需打磨",
    "比赛中的决策速度需要提升，减少犹豫时间",
  ],
  coachAdvice: "这场比赛是一个重要起点，蒋皓博开始主动进入比赛节奏。接下来的训练会重点练习突破时机和路线选择，帮助他把今天的勇气转化为稳定的技术动作。",
  nextSteps: [
    "专项练习突破起步时机",
    "加强比赛中的决策速度训练",
    "鼓励继续主动参与比赛",
...
export const mockVideos: Video[] = [
  ...
  },
  {
    ...
    thumbnailUrl: '/videos/poss-003_thumb.jpg', videoUrl: '',
